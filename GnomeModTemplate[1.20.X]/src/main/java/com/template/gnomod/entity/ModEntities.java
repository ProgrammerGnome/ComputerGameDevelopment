...
public class ModEntities {
    ...
    public static final EntityType<DeutschTomiEntity> DEUTSCHTOMI = Registry.register(Registries.ENTITY_TYPE,
            new Identifier(GnoModpack.MOD_ID, "deutschtomi"),
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, DeutschTomiEntity::new)
                    .dimensions(EntityDimensions.fixed(1f, 1f)).build());
