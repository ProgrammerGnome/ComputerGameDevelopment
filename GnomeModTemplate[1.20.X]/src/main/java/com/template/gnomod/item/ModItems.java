...
public class ModItems {
    ...
    public static final Item BENEE6_SPAWN_EGG = registerItem(
            new SpawnEggItem(ModEntities.BENEE6, 0xa86518, 0x3b260f, new FabricItemSettings()));

    public static final Item DEUTSCHTOMI_SPAWN_EGG = registerItem2(
            new SpawnEggItem(ModEntities.DEUTSCHTOMI, 0xa86518, 0x3b260f, new FabricItemSettings()));


    private static void addItemsToIngredientItemGroup(FabricItemGroupEntries entries) {
        entries.add(BENEE6_SPAWN_EGG);
        entries.add(DEUTSCHTOMI_SPAWN_EGG);
    }
    ...
    private static Item registerItem2(Item item) {
        return Registry.register(Registries.ITEM, new Identifier(GnoModpack.MOD_ID, "deutschtomi_spawn_egg"), item);
    }
